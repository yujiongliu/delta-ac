function [ acc ] = dltinvacc( ang,ps_t,ps_t_d, ps_t_dd )
% /***********************************************************************
% * Name:       Delta inverse acceleration
% * Type:       Function
% * Author:     Yujiong Liu
% * Date:       2015.6.9
% * 
% * Input:      [IN]    ang     Angles of the joints
% *             [IN]    ps_t    Position of the travelling plate
% *             [IN]    ps_t_d  First derivative of the travelling plate
% *             [IN]    ps_t_dd Second derivative of the travelling plate
% * Output:     [OUT]   acc     Acceleration of the joints
% * Function:   As name shown
% ***********************************************************************/
...
ang_d=dltinvjc(ps_t)*[ps_t_d(1);ps_t_d(2);ps_t_d(3)];
...
acc_1=(s_1'*[ps_t_dd(1);ps_t_dd(2);ps_t_dd(3)]+s_1_d'*s_1_d-s_1'*c_1_d*ang_d(1))/(s_1'*c_1);
acc_2=(s_2'*[ps_t_dd(1);ps_t_dd(2);ps_t_dd(3)]+s_2_d'*s_2_d-s_2'*c_2_d*ang_d(2))/(s_2'*c_2);
acc_3=(s_3'*[ps_t_dd(1);ps_t_dd(2);ps_t_dd(3)]+s_3_d'*s_3_d-s_3'*c_3_d*ang_d(3))/(s_3'*c_3);
